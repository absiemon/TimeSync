...
function PipelineForm() {
    ...
    const handleFinish = async (values) => {
        ...
        try {
            if (id) {
                await axios.put(`http://localhost:8000/api/pipeline/update/${id}`, obj);
                navigate("/pipeline")
            } else {
                        ...
                        >
                            <div className="table-responsive" style={{ padding: "20px 20px" }}>
                                ...
                                >
                                    ...
                                    <Row>
                                        <Col md={{ span: 11 }} xs={{ span: 22 }} style={{ margin: '0 14px' }}>
                                            <Button type="primary" onClick={handleIncrease}><PlusOutlined /> Add a stage</Button>
                                        </Col>
                                    </Row>

                                    <Row style={{ rowGap: '13px', marginTop: '10px' }}>
                                    ...
                                    <div className="form-buttons" style={{ display: "flex", justifyContent: "center" }}>
                                        <Form.Item
                                            ...
                                            wrapperCol={{ span: 24 }}
                                        >
                                            <Button type="primary" htmlType="submit" style={{ margin: "0px 10px" }} loading={loading}>
                                                Submit
                                            </Button>

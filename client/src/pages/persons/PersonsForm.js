...
function PersonsForm() {
    ...
    useEffect(() => {
        const fetchData = async () => {
            const res = await axios.get(`http://localhost:8000/api/organization/get`);
    ...
    const handleFinish = async () => {
        ...
        try {
            if (id) {
                await axios.put(`http://localhost:8000/api/persons/update/${id}`, values);
                navigate("/persons")
            } else {
                        ...
                        >
                            <div className="table-responsive" style={{ padding: "20px 20px" }}>
                                ...
                                >
                                    ...
                                    <Row>
                                        <Col md={{ span: 11 }} xs={{ span: 22 }} style={{ margin: '0 14px' }} >
                                            <Form.Item label="Organization" name="organization" rules={[{ required: true }]} labelAlign="left">
                                                <Select
